...
export default function MealsManager({ isOpen, onClose, meals, setMeals, saveMealsToDb }) {
  ...
  return (
    <div className="absolute inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
      <div className="w-[95%] h-[95%] max-h-[800px] flex flex-col rounded-[24px] bg-[#000000] bg-gradient-to-b from-[#141414] to-[#080808] border border-white/10 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.6)] overflow-hidden">
        ...
        {/* Add Meal Button */}
        {!addingMeal && (
          <div className="px-5 py-3 border-b border-white/5 bg-[#000000] bg-gradient-to-b from-[#141414] to-[#080808] shrink-0">
            <button
        ...
        {addingMeal && (
          <div className="p-5 border-b border-white/10 bg-gradient-to-b from-[#1e1e1e] to-[#111111] shrink-0 shadow-lg">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3 scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
          {meals.length === 0 ? (
            ...
            meals.map(meal => {
              ...
              return (
                <div key={meal.id} className={`rounded-[16px] border bg-gradient-to-b from-[#1e1e1e] to-[#111111] overflow-hidden transition-all ${isEditing ? "border-[#00d0ff]/60 shadow-[0_0_20px_rgba(0,208,255,0.12)]" : "border-white/10 hover:border-white/20"}`}>
