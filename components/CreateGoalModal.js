  ...
  return (
    <>
      ...
      >
        {/* Card */}
        <div
          className="w-full max-w-[360px] flex flex-col rounded-[24px] bg-[#000000] bg-gradient-to-b from-[#141414] to-[#080808] border border-white/10 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.6)] overflow-hidden"
        ...
        >
                ...
                {tasks.map((task, i) => {
                  ...
                  return (
                    <AnimatedTask key={task.id} style={{ animationDelay: `${i * 25}ms` }}>
                      <div className="flex items-center gap-2 rounded-[12px] bg-gradient-to-b from-[#1e1e1e] to-[#111111] border border-white/10 px-3 py-2.5 group hover:border-white/20 transition-all">
          ...
          {/* ── Footer */}
          <div className="shrink-0 px-5 pt-3 pb-5 border-t border-white/5 bg-[#000000] bg-gradient-to-b from-[#141414] to-[#080808]">
