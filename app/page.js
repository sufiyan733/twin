...
const T = {
  bg: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.02'/%3E%3C/svg%3E"), linear-gradient(145deg, rgba(255, 255, 255, 0.03) 0%, transparent 35%), radial-gradient(150% 120% at 50% -10%, rgba(110, 231, 183, 0.08) 0%, rgba(15, 23, 42, 0.6) 40%, transparent 100%), linear-gradient(180deg, #020617 0%, #000000 60%, #000000 100%)`,
