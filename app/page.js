...
const T = {
  bg: `url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.8' numOctaves='3' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23noiseFilter)' opacity='0.02'/%3E%3C/svg%3E"), linear-gradient(110deg, transparent 20%, rgba(255,255,255,0.02) 21%, rgba(255,255,255,0.06) 22%, transparent 23%), linear-gradient(110deg, transparent 60%, rgba(110,231,183,0.03) 61%, rgba(110,231,183,0.12) 62%, transparent 64%), radial-gradient(150% 150% at 50% 0%, rgba(110,231,183,0.12) 0%, rgba(15,23,42,0.6) 40%, transparent 100%), linear-gradient(180deg, #020617 0%, #000000 80%)`,
